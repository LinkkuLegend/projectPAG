/* $Id: togl.cpp,v 1.2 2005/01/23 22:09:01 sehmann Exp $ */
...
*/
	...
	entryPtr = Tcl_CreateHashEntry(&cmap->refCounts, (char *) newColor, &newEntry);
	if (newEntry) {
	    refCount = 1;
	} else {
   ...
   logical palette. */
       {
           int n, i;
           TkWinColormap *cmap = (TkWinColormap *)Tk_Colormap(togl->TkWin);
           LPPALETTEENTRY entry = (LPPALETTEENTRY)malloc(togl->EpsMapSize * sizeof(PALETTEENTRY));
