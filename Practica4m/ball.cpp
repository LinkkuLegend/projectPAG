...
//    _ballSpeed[0] = 0.001564498;
//    _ballSpeed[1] = 0.00187521;
//    _ballSpeed[2] = 0.0021554844;
...
int Ball::isInside(Vertex v)
{
    ...
    float euclideanDistance = sqrt(pow(_ballPos[0] - v.x,2) +
         pow(_ballPos[1] - v.y,2) +
         pow(_ballPos[2] - v.z,2));

    if(euclideanDistance < _radius)
        return 1;
    return 0;
}
